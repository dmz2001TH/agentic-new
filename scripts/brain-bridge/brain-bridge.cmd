...
REM Check G: drive
if not exist "G:\My Drive\Oracle-System-Brain\ψ" (
    echo [ERROR] G:\My Drive\Oracle-System-Brain\ψ not found!
    echo.
    echo Possible fixes:
    echo   1. Make sure Google Drive Desktop is running
    echo   2. Right-click Oracle-System-Brain folder
    echo      -^> "Make available offline"
    echo   3. Check if G: is mapped to the right drive letter
    echo.
    pause
    exit /b 1
)
...
robocopy "G:\My Drive\Oracle-System-Brain\ψ\memory" "C:\Agentic\ψ\memory" /MIR /XO /R:1 /W:1 /NFL /NDL /NJH /NJS /NC /NS /NP
robocopy "G:\My Drive\Oracle-System-Brain\ψ\agents" "C:\Agentic\ψ\agents" /MIR /XO /R:1 /W:1 /NFL /NDL /NJH /NJS /NC /NS /NP
robocopy "G:\My Drive\Oracle-System-Brain\ψ\vault" "C:\Agentic\ψ\vault" /MIR /XO /R:1 /W:1 /NFL /NDL /NJH /NJS /NC /NS /NP

REM Sync individual files
for %%f in (patterns.md notes.md decisions.md values.md goals.md people.md handoff.md) do (
    if exist "G:\My Drive\Oracle-System-Brain\ψ\%%f" (
        copy /Y "G:\My Drive\Oracle-System-Brain\ψ\%%f" "C:\Agentic\ψ\%%f" >nul 2>&1
    )
)
